...
public class Q2_Convertions {
    public static void main(String[] args) {
       ...
       //int to
        float f=(float)n;System.out.println(f);
        double d=(double)n;System.out.println(d);
        short s=(short)n;System.out.println(s);
        long l=(long)n;System.out.println(l);
        byte b=(byte)n;System.out.println(b);

        //float to
        int n2=(int)f;System.out.println(n2);
        double d2=(double)f;System.out.println(d2);
        ...
        //short to
        float f4=(float)s;System.out.println(f4);
        double d4=(double)s;System.out.println(d4);
        int s4=(int)s;System.out.println(s4);
        long l4=(long)s;System.out.println(l4);
        byte b4=(byte)s;System.out.println(b4);

        //long to
        float f5=(float)l;System.out.println(f5);
        double d5=(double)l;System.out.println(d5);
